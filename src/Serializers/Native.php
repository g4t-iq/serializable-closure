...
use Harmony\SerializableClosure\Support\ClosureScope;
use Harmony\SerializableClosure\Support\ClosureStream;
use Harmony\SerializableClosure\Support\ReflectionClosure;
use Harmony\SerializableClosure\Support\SelfReference;
use Harmony\SerializableClosure\UnsignedSerializableClosure;
...
class Native implements Serializable
{
     ...
     *
     * @var \Harmony\SerializableClosure\Support\ReflectionClosure|null
     */
    protected $reflector;
     ...
     * The closure's scope.
     *
     * @var \Harmony\SerializableClosure\Support\ClosureScope|null
     */
    protected $scope;
     ...
     */
    const ARRAY_RECURSIVE_KEY = 'Harmony_SERIALIZABLE_RECURSIVE_KEY';
     ...
     *
     * @param  mixed  $data
     * @param  \Harmony\SerializableClosure\Support\ClosureScope  $storage
     * @return void
     */
     ...
     *
     * @return \Harmony\SerializableClosure\Support\ReflectionClosure
     */
