...
namespace Harmony\SerializableClosure;

use Closure;
use Harmony\SerializableClosure\Exceptions\InvalidSignatureException;
use Harmony\SerializableClosure\Exceptions\PhpVersionNotSupportedException;
use Harmony\SerializableClosure\Serializers\Signed;
use Harmony\SerializableClosure\Signers\Hmac;
...
class SerializableClosure
{
     ...
     *
     * @var \Harmony\SerializableClosure\Contracts\Serializable
     */
     ...
     *
     * @param  Closure  $closure
     * @return \Harmony\SerializableClosure\UnsignedSerializableClosure
     */
